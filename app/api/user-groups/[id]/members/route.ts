 ...
 * GET /api/user-groups/:id/members - Get members list
 * DELETE /api/user-groups/:id/members - Remove a member (owner only)
 */
...
export async function DELETE(
  ...
  try {
    ...
    // Remove the member
    const deleted = await prisma.userGroupMember.deleteMany({
      where: {
        groupId: params.id,
        userId: memberId,
      },
