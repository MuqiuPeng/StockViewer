...
export default function IndicatorSelector({
  ...
  return (
    <div 
      className="indicator-selector border border-gray-200 rounded"
    ...
    >
      ...
      >
        <div className="flex items-center justify-between mb-2">
          ...
          <svg
            className={`w-5 h-5 transform transition-transform flex-shrink-0 ${isCollapsed ? '' : 'rotate-180'}`}
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
        ...
        {isCollapsed && enabledCount === 0 && (
          <div className="text-xs text-gray-500 mt-1">No indicators selected</div>
        )}
      </div>
